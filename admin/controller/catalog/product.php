	...
	protected function getForm() {
		...
		// Attributes
			...
			foreach($attributes as $attribute){
				$allattributes[$attribute['attribute_id']]=$attribute;
			}
			...
			foreach($templates as $template){
				...
				foreach($attribute_template as $at){
					if(isset($allattributes[$at['attribute_id']])){
						$allattributes[$at['attribute_id']]['values'][$at['language_id']]=$at['text'];
						$template_attributes[$at['attribute_id']]=$allattributes[$at['attribute_id']];
					}

				}

				$data['templates'][$template['template_id']]=array('name'=>$template['name'],'template_id'=>$template['template_id'],'attributes'=>$template_attributes);
